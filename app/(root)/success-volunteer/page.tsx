...
import { getVolunteerDetails } from "@/lib/actions/user/volunteer.actions";
...
const page = async ({ searchParams }: { searchParams: any }) => {
	...
	const res = await getVolunteerDetails(id);
		...
		<div>
			<Showcase>
				<h1 className="text-5xl lg:text-7xl font-bold">
					Thank you for{" "}
					<span className="italic text-secondary">volunteering</span>{" "}
				</h1>
